...
def pbcwire(vecs):
	...
	mv = vecs
	mlab.plot3d(array([0.,mv[0],mv[0],0,0.,0.,mv[0],mv[0],0,0]),array([0.,0.,mv[1],mv[1],0,0,0,mv[1],mv[1],0]),array([0.,0.,0.,0.,0.,mv[2],mv[2],mv[2],mv[2],mv[2]]))
	mlab.plot3d(array([0,0,mv[0],mv[0],mv[0],mv[0]]),array([mv[1],mv[1],mv[1],mv[1],0,0]),array([0,mv[2],mv[2],0,0,mv[2]]))
